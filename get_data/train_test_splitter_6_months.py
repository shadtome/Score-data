...
class train_test:
    ...
    def get_splits(self,train_size,seed):
        ...
        temp = temp[temp['date']>=temp['6_months']]
        ...
        agg_data_6_months = temp.groupby(by=['name','date_of_birth_ss'],as_index=False).agg(agg_info)

        combine = agg_data.merge(agg_data_6_months,on = 'name',how='left')
        ...
        combine = combine.rename(columns={'date_of_birth_ss_x': 'dob',
                                          ...
                                          'league_x':'league',
                                             ...
                                             'adjusted_market_value_in_eur_x': 'adjusted_market_value'})
        combine = combine.drop(labels=['date_of_birth_ss_y','height_y','date_y','team_y','league_y','position_acronym_y',
                             'market_value_in_eur_y','adjusted_market_value_in_eur_y'],axis=1)
